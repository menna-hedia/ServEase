...
export default function ProviderRequestDetails() {
  ...
  const handleAccept = async (e: React.FormEvent) => {
    ...
    const hasPreferredPrice = !isHourly && request?.preferredPrice > 0;
    ...
    if (!offerData.endTime || (!isHourly && !hasPreferredPrice && !offerData.price)) {
      toast.error('Please fill all fields');
      return;
    }
                    ...
                    {(() => {
                      ...
                      return (
                        <>
                          <div className="flex justify-between text-sm">
                            <span className="text-muted-foreground">Hourly Rate</span>
                            <span className="font-semibold">EGP {request.provider?.hourPrice}/hr</span>
                          </div>
                          {estimated && (
                            <>
                              <div className="flex justify-between text-sm">
                                <span className="text-muted-foreground">Estimated Hours</span>
                                <span className="font-semibold">{(estimated / (request.provider?.hourPrice || 1)).toFixed(1)} hours</span>
                              </div>
                              <div className="flex justify-between text-sm border-t pt-2">
                                <span className="font-semibold">Estimated Earnings</span>
                                <span className="font-bold text-green-600">EGP {estimated}</span>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between bg-muted rounded-lg p-3">
                <div>
                  ...
                  <p className="font-semibold">EGP {request.preferredPrice}</p>
                </div>
