...
//                     className={`w-full text-left px-3 py-2 rounded-lg transition-colors ${!selectedService ? 'bg-primary text-white' : 'hover:bg-muted'
//                       }`}
//                   >
//                     All Categories
//                   </button>
...
//                       className={`w-full text-left px-3 py-2 rounded-lg transition-colors ${selectedService?._id === service._id ? 'bg-primary text-white' : 'hover:bg-muted'
//                         }`}
//                     >
//                       {service.name}
//                     </button>
...
//                               { provider.service?._id ?.name || selectedService?.name || ''}
//                             </p>
//                           </div>
...
//                 </p>
//                 <p className="text-sm text-muted-foreground">
//                   {selectedProvider.service?._id .name || selectedService?.name} //******************************* */
//                 </p>
//               </div>
//             </div>
//           </div>
